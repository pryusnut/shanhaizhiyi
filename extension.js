...
var qinyin={
	...
	"boss_abaaba":"阿巴",
	"boss_abaaba_info":"持恒技，你的回合结束时，你展示牌堆底的一张牌并使用之。若如此做，你重复此流程，直到你以此法展示的牌无法使用为止，然后你获得那张牌。",
	"boss_miaowu":"喵呜",
	"boss_miaowu_info":"持恒技，当你死亡时，你选择一种类型（基本/锦囊/装备/其他），然后翻开牌堆底的一张牌并获得之，若那张牌的类型和你选择的类型一样，则你不死亡，将体力值上限变成2，体力值回复至2，并摸一张牌。",
	"boss_langqinbiao_draw":"感知",
	"boss_chiliu":"哧溜",
	"boss_chiliu_info":"持恒技，你进入濒死状态时，立即死亡，你不会被翻面，与其他角色计算的距离-1，手牌上限+2；你的回合开始时，你受到一点雷属性伤害。并获得判定区里的所有牌。",
	"boss_guihuoa":"鬼火",
	...
	boss_zhangrang1:{moshi:'2',renshu:'1',num:15,limit:5},
	...
	text.innerText=num;
	game.saveConfig('extension_'+'山海志异_'+'jiawei_limit',num);
	}
	},
